...
<t:template title="The Dance Company">
	...
	<jsp:attribute name="header">
		<link rel="stylesheet" href="http://localhost:8080/dance_company/css/cart.css" type="text/css" />
	</jsp:attribute>
                ...
                <div class="p-5">
                  ...
                  <hr class="m-0">
					...
					<c:forEach var="cartItem" items="${sessionScope.cart}">
						...
						<div class="cart-item row d-flex justify-content-between align-items-center p-4">
                    <div class="col-md-2 col-lg-2 col-xl-2">
                      <img src="http://localhost:8080/dance_company/images/${cartItem.image}" class="img-fluid rounded-3" alt="Cotton T-shirt">
                    </div>
                    ...
                    <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                      <a href="CartServlet?action=remove&id=${cartItem.id}" class="text-muted"><i class="fas fa-times"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="pt-5">
                    <h6 class="mb-0">
						<a href="/dance_company/BookingServlet" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Back to classes</a>
					</h6>
                  </div>
                </div>
              </div>
